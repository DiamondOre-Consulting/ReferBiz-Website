...
const App = () => {
  ...
  return (
    <>
      <Routes>
        {/* Public Routes accessible to anyone except vendors */}
        ...
        <Route
          path='/register'
          element={
            role === "VENDOR" ? <Navigate to="/vendor/dashboard" replace /> : <Register />
          }
        />
        ...
        <Route
          path='/vendor-list'
          element={
            role === "VENDOR" ? <Navigate to="/vendor/dashboard" replace /> : <VendorList />
          }
        />
        <Route
          path='/contact'
          element={
            role === "VENDOR" ? <Navigate to="/vendor/dashboard" replace /> : <Contact />
          }
        />
