...
export const vendorLoginAccount = createAsyncThunk(
  "/vendor/login",
  async (data) => {
    try {
...
export const vendorEditProfile = createAsyncThunk(
...
export const vendorChangePassword = createAsyncThunk(
...
export const vendorResetPassword = createAsyncThunk(
  "vendor/forgot-password",
  async (data) => {
    try {
